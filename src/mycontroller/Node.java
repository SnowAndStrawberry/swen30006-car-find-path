...
import mycontroller.ITileAdapter;
...
public class Node {
     ...
     */
    public Node(Coordinate c, float health, float fuelCost, float healthUsage, WorldSpatial.Direction movingDirection) {
        this.c               = c;
        this.health          = health;
    ...
    public ArrayList<Node> getNeighbors(MapRecorder map,
        ...
        for (Coordinate adj : adjacentCoordinates) {
            ...
            res.add(new Node(adj, adjHealth, adjFuelCost, FORWARD_VELOCITY, nextMovingDirection));
        }
